...
async function entrar() {
  ...
  try {
    ...
    mensagemLogin.value = err.response?.data?.mensagem || 'E-mail ou senha incorretos.'
...
async function cadastrar() {
  ...
  try {
    ...
    erroCadastro.value = err.response?.data?.mensagem || 'Erro ao cadastrar. Tente outro e-mail.'
  } finally {
